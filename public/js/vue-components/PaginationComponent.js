// このファイルは `vuejs-paginate` ( https://github.com/lokyoung/vuejs-paginate )
// を元になっていますが、オリジナルは Vue 2 までのサポートのためいくつかカスタマイズしています。
// なお、これに伴いまして common.scss, common.css も変更しています。
//
// ※１ ・・・といいますのも、ページネーションは実装がシンプルに見えて相当複雑なため、このパッケージを流用しました。
// もし何かエラーが出るならシンプルにスライド形式を採用するほうがいいかもしれません。
// ※２ そのため、学習用のコードとしてはご説明は難しいかと思います。。
