...
@section('content')
  <div id="one-column" class="post-form">
    ...
    <div style="border: 2px solid brown; padding:0.5rem; background-color: lemonchiffon; margin: 11rem 0 2rem">
      ...
      <div class="mb-3" v-if="articleCategory === 300">
        <p class="label">サブカテゴリー</p>
        {{-- <label for="category">カテゴリー：</label> --}}
        <select id="sub-category" class="form-select" v-model="subCategory">
          <option>--------</option>
          <option v-for="category in subCategories" v-text="category.name" :value="category.id"></option>
        </select>
      </div>
    ...
    <div class="buttons my-5 mx-auto d-flex justify-content-around">
      <button v-if="formBlockCount > 0" class="btn btn-danger mr-3" @click="removeForm">末尾のフォームブロックを削除</button>
        ...
        <main id="main">
          ...
          <div class="content-block">
            <section class="content-section">
              <div class="section-content-block" v-text="articleIntroduction"></div>
            </section>
