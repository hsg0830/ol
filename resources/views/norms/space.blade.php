        ...
        <div class="term__description">
          <div class="example">
            <table>
              ...
              <tr>
                <td class="text-left">김영남군당책임비서, 리순실동사무부장, 리남순과학지도국장, 리철호실장선생</td>
              </tr>
              <tr>
        ...
        <div class="term__description">
          <div class="example">
            <table>
              ...
              <tr>
                <td class="text-left">고유한 우리 말 어근으로 세말을 만든다.</td>
              </tr>
            </table>
          </div>
        </div>
      ...
      <div class="term">
        ...
        <div class="term__description">
          <div class="example">
            <table>
              <tr>
                <td class="text-left">3대혁명붉은기쟁취운동 궐기모임</td>
              </tr>
              <tr>
